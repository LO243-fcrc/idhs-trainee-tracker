...
const { listMetrics, createMetric, updateMetric, deleteMetric } = require('../controllers/metrics.controller');
const { listReviews, getTraineeReviews, createReview, updateReview, deleteReview } = require('../controllers/quarterlyReview.controller');
...
router.post('/trainees/:traineeId/metrics/:category', recordTraineeMetric);
...
router.post('/trainees/:traineeId/assign-course', requireAuth, assignCourseToTrainee);
router.delete('/trainees/:traineeId/assign-course/:courseId', requireAuth, unassignCourseFromTrainee);
...
router.post('/trainees/:traineeId/self-report-credentials', requireAuth, issueSelfReportCredentials);
...
router.post('/metrics', requireAdmin, createMetric);
router.patch('/metrics/:id', requireAdmin, updateMetric);
router.delete('/metrics/:id', requireAdmin, deleteMetric);

// Quarterly Reviews endpoints
router.get('/reviews', listReviews);
router.get('/trainees/:traineeId/reviews', getTraineeReviews);
