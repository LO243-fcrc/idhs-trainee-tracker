  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Trainee Detail Page">
        ...
        <Step number={6}><strong>Program Progress</strong> — assign training courses to the trainee using the "Assign Course" button. Once assigned, track each course's completion status (Not Started / In Progress / Completed) as the trainee works through modules.</Step>
      </Section>
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Instructions to give your trainees">
        ...
        <Step number={6}>Log out when you're done, especially on a shared computer.</Step>
      </Section>
