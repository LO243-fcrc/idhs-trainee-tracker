...
export default function Users() {
        ...
        <tbody className="divide-y divide-slate-200">
          {users.map((user) => {
            ...
            <tr key={user.id} className="bg-white hover:bg-slate-50">
              {editingId === user.id ? (
                <>
                  <td className="px-4 py-3"><input type="text" value={editName} onChange={(e) => setEditName(e.target.value)} className="w-full rounded border border-slate-300 px-2 py-1 text-sm" /></td>
                  <td className="px-4 py-3"><input type="email" value={editEmail} onChange={(e) => setEditEmail(e.target.value)} className="w-full rounded border border-slate-300 px-2 py-1 text-sm" /></td>
                  <td className="px-4 py-3"><input type="password" placeholder="Leave blank to keep" value={editPassword} onChange={(e) => setEditPassword(e.target.value)} className="w-full rounded border border-slate-300 px-2 py-1 text-sm" /></td>
  ...
  const AddUserForm = ({ role, roleName }) => (
        ...
        {isLoading ? (
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-3">
              ...
              {addSection === 'trainer' && <AddUserForm role="MANAGEMENT" roleName="Trainer" />}
            ...
            <section className="space-y-3">
              ...
              {addSection === 'manager' && <AddUserForm role="MANAGEMENT" roleName="Manager" />}
            ...
            <section className="space-y-3">
              ...
              {addSection === 'admin' && <AddUserForm role="ADMIN" roleName="Administrator" />}
