                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {bottleneck.helpRequestCount > 0 && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-red-50 px-2 py-1 text-xs font-medium text-red-700 border border-red-200 mt-1">
                          {bottleneck.helpRequestCount} trainee{bottleneck.helpRequestCount > 1 ? 's' : ''} requested help
                        </span>
                      )}
                    </div>
                  </div>
