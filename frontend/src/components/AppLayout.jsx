...
// Logical navigation order: Dashboard → Progress → Submissions → Bottlenecks → Trainees → Courses → Metrics → Quarterly Reviews → Users → Reports → Help
const NAV_ITEMS = [
  ...
  { to: '/metrics', label: 'Metrics', Icon: SettingsIcon },
  { to: '/quarterly-reviews', label: 'Quarterly Reviews', Icon: ReportsIcon },
...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 mx-auto w-full max-w-7xl px-4 py-6 pb-12">
        {children}
      </main>
    </div>
  );
