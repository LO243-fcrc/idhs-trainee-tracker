...
export default function HighwayTrainingEditor() {
  ...
  console.log('[HighwayTrainingEditor] Component mounted');

  useEffect(() => {
    console.log('[HighwayTrainingEditor] useEffect: Loading weeks...');
    loadWeeks();
  }, []);

  async function loadWeeks() {
    console.log('[HighwayTrainingEditor] loadWeeks() called');
    setIsLoading(true);
    try {
      console.log('[HighwayTrainingEditor] Calling api.getHighwayTrainingWeeks()...');
      const data = await api.getHighwayTrainingWeeks();
      console.log('[HighwayTrainingEditor] Got weeks:', data.weeks);
      setWeeks(data.weeks || []);
    } catch (err) {
      console.error('[HighwayTrainingEditor] Error loading weeks:', err);
