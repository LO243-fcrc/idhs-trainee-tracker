...
export const api = {
  ...
  setHighwayTrainingDates: (traineeId, highwayTrainingStartDate, highwayTrainingEndDate) =>
    apiRequest(`/admin/trainees/${traineeId}/highway-training`, {
      method: 'PATCH',
  ...
  // Metrics CRUD
  listMetrics: () => apiRequest('/admin/metrics'),
  createMetric: (data) => apiRequest('/admin/metrics', { method: 'POST', body: JSON.stringify(data) }),
  updateMetric: (id, data) => apiRequest(`/admin/metrics/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  deleteMetric: (id) => apiRequest(`/admin/metrics/${id}`, { method: 'DELETE' }),

  // Highway Training
  getHighwayTrainingWeeks: () => apiRequest('/admin/highway-training'),
  updateHighwayTrainingWeek: (weekNumber, data) => apiRequest(`/admin/highway-training/${weekNumber}`, { method: 'PATCH', body: JSON.stringify(data) }),

  // Quarterly Reviews
  listReviews: () => apiRequest('/admin/reviews'),
  getTraineeReviews: (traineeId) => apiRequest(`/admin/trainees/${traineeId}/reviews`),
  createReview: (traineeId, reviewNumber) => apiRequest('/admin/reviews', { method: 'POST', body: JSON.stringify({ traineeId, reviewNumber }) }),
  updateReview: (reviewId, data) => apiRequest(`/admin/reviews/${reviewId}`, { method: 'PATCH', body: JSON.stringify(data) }),
  deleteReview: (reviewId) => apiRequest(`/admin/reviews/${reviewId}`, { method: 'DELETE' }),
};
